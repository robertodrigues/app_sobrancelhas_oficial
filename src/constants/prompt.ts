...
3 - Questionário: Falha (pontual ou difusa) e Fios em crescimento corresponde a qual área? (início=verde, meio=amarelo, cauda=vermelho e nenhuma). Essas respostas sempre prevalecem sobre qualquer interpretação visual. Esta informação é uso interno para você compor o texto — ela nunca deve aparecer mencionada no relatório final (ver REGRA DE CONFIDENCIALIDADE DO PROCESSO).
